								...
								<div class="input-box mb-4">									
									<div class="form-group">
										<label class="custom-switch mb-0">
											...
											<span class="custom-switch-description"><?php echo e(__('Include Your Brand')); ?></span>
										</label>
									</div>
								</div>								
							</div>												
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="col-sm-12">
							<div class="form-group">	
								...
								<?php if (isset($component)) { $__componentOriginal0a855082c82cd57c7d2192f78162e20278bcd365 = $component; } ?>
<?php $component = App\View\Components\OriginalTemplateModels::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('original-template-models'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\OriginalTemplateModels::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0a855082c82cd57c7d2192f78162e20278bcd365)): ?>
<?php $component = $__componentOriginal0a855082c82cd57c7d2192f78162e20278bcd365; ?>
<?php unset($__componentOriginal0a855082c82cd57c7d2192f78162e20278bcd365); ?>
<?php endif; ?>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="input-box mb-0 mt-5">
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Results')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Maximum supported results is 50')); ?>"></i></h6>
								<div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="max_results" name="max_results" placeholder="e.g. 5" max="50" min="1" value="1">
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box mt-5">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Estimated Result Length')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Estimated words length for each generated text result')); ?>"></i></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="input-box mb-4">									
										<div class="form-group">
											<label class="custom-switch mb-0">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description"><?php echo e(__('Internet Access')); ?></span>
											</label>
										</div>
									</div>								
								</div>	
								...
								<div class="template-action-buttons">
									<div class="btn-group w-100">
										...
										<div class="dropdown-menu" aria-labelledby="export" data-popper-placement="bottom-start">								
											...
											<a class="dropdown-item" id="export-word" onclick="exportWordEditor();"><i class="fa-sharp fa-solid fa-file-word fs-13 text-muted mr-2"></i><?php echo e(__('MS Word')); ?></a>
											
										</div>
									</div>
								</div>
								<a id="save-button-template" class="template-button" onclick="return saveText(this);" href="#"><i class="fa-solid fa-floppy-disk-pen table-action-buttons table-action-buttons-big delete-action-button" data-tippy-content="<?php echo e(__('Save Document')); ?>"></i></a>				
							</div>
						</div>
					...
					<div>						
						<div id="template-textarea">						
							...
							<div>
								<p class="text-muted fs-12 total-words-templates-box"><?php echo e(__('Total Words')); ?>: <span id="total-words-templates"></span></p>
							</div>
						</div>									
					</div>
				</div>
...
<script type="text/javascript">
	...
	function saveText(event) {
		...
		if (!event.target) {
			toastr.warning('<?php echo e(__('You will need to rewrite an article first before saving your changes')); ?>');
			document.querySelector('#loader-line')?.classList?.add('hidden');  
		} else {
			$.ajax({
				headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/lskdnzmy/public_html/resources/views/user/templates/original-template.blade.php ENDPATH**/ ?>
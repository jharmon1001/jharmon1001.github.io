	...
	<div class="row mt-24">
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="border-0 templates-nav-header">
				<div class="card-body">
					<div>
						<h3 class="card-title mb-3 ml-2 fs-20 super-strong"><i class="fa-solid fa-microchip-ai mr-2 text-primary"></i><?php echo e(__('AI Writer')); ?></h3>
						...
						<?php if(config('settings.custom_templates') == 'anyone'): ?>
							<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple rtl-main-button" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Template')); ?></a>
						<?php else: ?>
							<?php if($check): ?>
								<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-primary ripple rtl-main-button" id="create-ai-button" style="text-transform: none;"><?php echo e(__('Create Custom Template')); ?></a>
							<?php endif; ?>	
							...
							<div class="row" id="templates-panel">
								<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if(strtolower($category->name) != 'other'): ?>
											...
											<?php if($template->group == $category->code): ?>
												<div class="col-lg-3 col-md-6 col-sm-12">
													<div class="template">
														...
														<div class="card <?php if($template->package == 'professional'): ?> professional <?php elseif($template->package == 'premium'): ?> premium <?php elseif($template->favorite): ?> favorite <?php else: ?> border-0 <?php endif; ?>" id="<?php echo e($template->template_code); ?>-card" onclick="window.location.href='<?php echo e(url('user/templates/original-template')); ?>/<?php echo e($template->slug); ?>'">
										...
										<?php $__currentLoopData = $private_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($template->group == $category->code): ?>
												<div class="col-lg-3 col-md-6 col-sm-12">
													<div class="template">
														<a id="<?php echo e($template->template_code); ?>" <?php if($template->favorite): ?> data-tippy-content="<?php echo e(__('Remove from favorite')); ?>" <?php else: ?> data-tippy-content="<?php echo e(__('Select as favorite')); ?>" <?php endif; ?> onclick="favoriteStatusCustom(this.id)"><i id="<?php echo e($template->template_code); ?>-icon" class="<?php if($template->favorite): ?> fa-solid fa-stars <?php else: ?> fa-regular fa-star <?php endif; ?> star"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/lskdnzmy/public_html/resources/views/user/templates/index.blade.php ENDPATH**/ ?>
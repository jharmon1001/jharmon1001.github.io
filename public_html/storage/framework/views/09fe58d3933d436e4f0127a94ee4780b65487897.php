...
<form id="wizard-form" action="" method="post" enctype="multipart/form-data" class="mt-24"> 		
	...
	<div class="row justify-content-center">	
		<div class="col-sm-12 text-center">
			<h3 class="card-title fs-20 mb-0 super-strong"><i class="fa-solid fa-sharp fa-sparkles mr-2 text-primary"></i><?php echo e(__('AI Article Wizard')); ?></h3>
					...
					<div class="row text-center justify-content-center">
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title"><span class="font-weight-bold fs-14"><?php echo e(__('Get Ideas')); ?></span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left"><?php echo e(__('STEP 1')); ?></span></div>
							</div>
							<div>
						...
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title responsive"><span class="font-weight-bold fs-14"><?php echo e(__('Outlines')); ?></span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left"><?php echo e(__('STEP 2')); ?></span></div>
							</div>	
							<div>
						...
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title"><span class="font-weight-bold fs-14"><?php echo e(__('Talking Points')); ?></span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left"><?php echo e(__('STEP 3')); ?></span></div>
							</div>	
							<div>
						...
						<div class="col-3">
							<div class="d-flex wizard-nav-text">
								...
								<div class="wizard-step-title responsive"><span class="font-weight-bold fs-14"><?php echo e(__('Images')); ?></span> <br> <span class="text-muted wizard-step-title-number fs-11 float-left"><?php echo e(__('STEP 4')); ?></span></div>
							</div>									
						</div>
					</div>					
				</div>
			</div>			
			<a href="#" id="new-wizard" data-tippy-content="<?php echo e(__('New Article Wizard')); ?>"><i class="fa-solid fa-layer-plus"></i></a>			
		</div>
					...
					<div class="card-body p-5 pb-0">
						...
						<div class="row">						
							<div class="col-sm-12 step-one">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Topic')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>	
									<span id="topic-length" style="display:none">2000</span>								
									<div class="form-group">						  
										<textarea type="text" rows=5 class="form-control" id="topic" name="topic" placeholder="<?php echo e(__('Describe what your article is about')); ?>" required></textarea>								 
									</div> 
								</div> 
							</div>	
							...
							<div class="col-sm-12 general hidden">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Title')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>	
									<span id="title-length" style="display:none">2000</span>								
									<div class="form-group">						  
										<textarea type="text" rows=1 class="form-control" id="title" name="title" placeholder="<?php echo e(__('Provide your article title')); ?>" required></textarea>								 
									</div> 
								</div> 
							</div>	
							...
							<div class="col-md-6 step-one">
								<div class="input-box mb-4">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Topics')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-md-6 step-one">
								<div class="input-box mb-4">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Maximum Topic Words')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 last-step-extra">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Keywords')); ?></h6>									
									<span id="keywords-length" style="display:none">1000</span>
									<div class="form-group">				  
										<input type="text" class="form-control" id="keywords" name="keywords" placeholder="<?php echo e(__('Type your keywords')); ?>">
									</div> 
								</div> 
							</div>	
							
							<div class="text-center step-one">
								<p class="text-muted fs-11 mb-1"><?php echo e(__('or')); ?></p>
							</div>							
							
							<div class="col-sm-12 step-one">
								<div class="input-box mb-4">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Keywords')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 step-one">
								<div class="text-center">
									<button class="btn btn-keywords ripple fs-11 pl-6 pr-6 pt-2 pb-2 fs-11" id="generate-keywords"><?php echo e(__('Generate Keywords')); ?></button>
								</div>
							</div>

							<div class="col-sm-12 step-two hidden">
								<div class="input-box mb-4">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Outlines')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 step-two hidden">
								<div class="input-box mb-4">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Subtitles')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 step-three hidden">								
								<div>	
									<h6 class="fs-11 mb-0 font-weight-semibold"><?php echo e(__('Article Outline')); ?></h6>	
									<span class="fs-11 text-muted"><?php echo e(__('You can drag and drop to rearrange sections')); ?></span>								
								</div> 
								<div id="outline-results-wrapper">
									<ul id="outline-results-list"></ul>
									<a href="#" id="add-new-section" class="fs-11 text-muted"><i class="fa-solid fa-circle-plus mr-2"></i> <?php echo e(__('Add New Section')); ?></a>
								</div>
							</div>

							<div class="col-sm-12 step-three hidden">
								<div class="input-box mb-4 mt-3">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Talking Points per Outline')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 step-three hidden">
								<div class="input-box mb-4 mt-2">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Maximum Talking Point Words')); ?></h6>									
									<div class="form-group">				  
							...
							<div class="col-sm-12 step-four hidden">								
								<div class="input-box">	
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Image Description')); ?></h6>	
							...
							<div class="col-sm-12 step-four hidden">
								<div id="form-group" class="mb-4">
									<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Image Size')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('The image resolution of the generated images')); ?>"></i></h6>
									<select id="image_size" name="image_size" class="form-select">																	
										<?php if(config('settings.wizard_image_vendor') == 'dall-e-2'): ?>
										...
										<?php elseif(config('settings.wizard_image_vendor') == 'dall-e-3' || config('settings.wizard_image_vendor') == 'dall-e-3-hd'): ?>			
										...
										<?php elseif(config('settings.wizard_image_vendor') == 'stable-diffusion-v1-6'): ?>
										...
										<?php elseif(config('settings.wizard_image_vendor') == 'stable-diffusion-xl-1024-v1-0'): ?>
										...
										<?php elseif(config('settings.wizard_image_vendor') == 'none'): ?>
											<option value='none'><?php echo e(__('Image generation feature is disabled')); ?></option>
										<?php endif; ?>																																																																																																																																							
									</select>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="divider mt-0" id="wizard-advanced">
									<div class="divider-text text-muted">
										<a class="fs-11 text-muted" id="advanced-settings-toggle" href="#"><?php echo e(__('Advanced Options')); ?> <span>+</span></a>
									</div>
								</div>
							</div>
...
<?php endif; ?>
								...
								<div class="col-md-12 col-sm-12 mt-5">
									<div id="form-group">
										<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Writing Tone')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Set result tone of the text as needed')); ?>"></i></h6>
										<select id="tone" name="tone" class="form-select" >
											<option value="Professional" <?php if($wizard['tone'] == 'Professional'): ?> selected <?php endif; ?>> <?php echo e(__('Professional')); ?></option>	
											<option value="Exciting" <?php if($wizard['tone'] == 'Exciting'): ?> selected <?php endif; ?>> <?php echo e(__('Exciting')); ?></option>	
											<option value="Friendly" <?php if($wizard['tone'] == 'Friendly'): ?> selected <?php endif; ?>> <?php echo e(__('Friendly')); ?></option>	
											<option value="Witty" <?php if($wizard['tone'] == 'Witty'): ?> selected <?php endif; ?>> <?php echo e(__('Witty')); ?></option>	
											<option value="Humorous" <?php if($wizard['tone'] == 'Humorous'): ?> selected <?php endif; ?>> <?php echo e(__('Humorous')); ?></option>	
											<option value="Convincing" <?php if($wizard['tone'] == 'Convincing'): ?> selected <?php endif; ?>> <?php echo e(__('Convincing')); ?></option>	
											<option value="Empathetic" <?php if($wizard['tone'] == 'Empathetic'): ?> selected <?php endif; ?>> <?php echo e(__('Empathetic')); ?></option>	
											<option value="Inspiring" <?php if($wizard['tone'] == 'Inspiring'): ?> selected <?php endif; ?>> <?php echo e(__('Inspiring')); ?></option>	
											<option value="Supportive" <?php if($wizard['tone'] == 'Supportive'): ?> selected <?php endif; ?>> <?php echo e(__('Supportive')); ?></option>	
											<option value="Trusting" <?php if($wizard['tone'] == 'Trusting'): ?> selected <?php endif; ?>> <?php echo e(__('Trusting')); ?></option>	
											<option value="Playful" <?php if($wizard['tone'] == 'Playful'): ?> selected <?php endif; ?>> <?php echo e(__('Playful')); ?></option>	
											<option value="Excited" <?php if($wizard['tone'] == 'Excited'): ?> selected <?php endif; ?>> <?php echo e(__('Excited')); ?></option>	
											<option value="Positive" <?php if($wizard['tone'] == 'Positivite'): ?> selected <?php endif; ?>> <?php echo e(__('Positive')); ?></option>	
											<option value="Negative" <?php if($wizard['tone'] == 'Negative'): ?> selected <?php endif; ?>> <?php echo e(__('Negative')); ?></option>	
											<option value="Engaging" <?php if($wizard['tone'] == 'Engaging'): ?> selected <?php endif; ?>> <?php echo e(__('Engaging')); ?></option>	
											<option value="Worried" <?php if($wizard['tone'] == 'Worried'): ?> selected <?php endif; ?>> <?php echo e(__('Worried')); ?></option>	
											<option value="Urgent" <?php if($wizard['tone'] == 'Urgent'): ?> selected <?php endif; ?>> <?php echo e(__('Urgent')); ?></option>	
											<option value="Passionate" <?php if($wizard['tone'] == 'Passionate'): ?> selected <?php endif; ?>> <?php echo e(__('Passionate')); ?></option>	
											<option value="Informative" <?php if($wizard['tone'] == 'Informative'): ?> selected <?php endif; ?>> <?php echo e(__('Informative')); ?></option>
											<option value="Funny" <?php if($wizard['tone'] == 'Funny'): ?> selected <?php endif; ?>><?php echo e(__('Funny')); ?></option>
											<option value="Casual" <?php if($wizard['tone'] == 'Casual'): ?> selected <?php endif; ?>> <?php echo e(__('Casual')); ?></option>																																																														
											<option value="Sarcastic" <?php if($wizard['tone'] == 'Sarcastic'): ?> selected <?php endif; ?>> <?php echo e(__('Sarcastic')); ?></option>																																																																																												
											<option value="Dramatic" <?php if($wizard['tone'] == 'Dramatic'): ?> selected <?php endif; ?>> <?php echo e(__('Dramatic')); ?></option>																																																													
										</select>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12 mt-5">
									<div id="form-group">
										<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Creativity')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Increase or decrease the creativity level to get variety in generated results')); ?>"></i></h6>
										<select id="creativity" name="creativity" class="form-select">
											<?php if(!is_null($wizard['creativity'])): ?>
												<option value=0 <?php if($wizard['creativity'] == 0): ?> selected <?php endif; ?>><?php echo e(__('Repetitive')); ?></option>
												<option value=0.25 <?php if($wizard['creativity'] == 0.25): ?> selected <?php endif; ?>> <?php echo e(__('Deterministic')); ?></option>																															
												<option value=0.5 <?php if($wizard['creativity'] == 0.5): ?> selected <?php endif; ?>> <?php echo e(__('Original')); ?></option>																															
												<option value=0.75 <?php if($wizard['creativity'] == 0.75): ?> selected <?php endif; ?>> <?php echo e(__('Creative')); ?></option>																															
												<option value=1 <?php if($wizard['creativity'] == 1): ?> selected <?php endif; ?>> <?php echo e(__('Imaginative')); ?></option>		
											<?php else: ?>
												<option value=0><?php echo e(__('Repetitive')); ?></option>
												<option value=0.25> <?php echo e(__('Deterministic')); ?></option>																															
												<option value=0.5> <?php echo e(__('Original')); ?></option>																															
												<option value=0.75> <?php echo e(__('Creative')); ?></option>																															
												<option value=1 selected> <?php echo e(__('Imaginative')); ?></option>	
											<?php endif; ?>
								...
								<div class="col-md-12 col-sm-12 mt-5">
									<div id="form-group">
										<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Point of View')); ?></h6>
										<select id="view_point" name="view_point" class="form-select">
											<option value="first" <?php if($wizard['view_point'] == 'first'): ?> selected <?php endif; ?>><?php echo e(__('First Person')); ?></option>
											<option value="second" <?php if($wizard['view_point'] == 'second'): ?> selected <?php endif; ?>> <?php echo e(__('Second Person')); ?></option>																															
											<option value="third" <?php if($wizard['view_point'] == 'third'): ?> selected <?php endif; ?>> <?php echo e(__('Third Person')); ?></option>																																															
										</select>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12">								
									<div class="input-box mt-5">								
										<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Article Length')); ?></h6>
										<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>" id="words" name="words" placeholder="e.g. 1000" <?php if(!is_null($wizard['max_words'])): ?> value="<?php echo e($wizard['max_words']); ?>" <?php endif; ?>>
									...
									<div class="form-group">	
										...
										<select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Select input language')); ?>">		
											<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if(!is_null($wizard['language'])): ?>
													<option value="<?php echo e($language->language_code); ?>" data-img="<?php echo e(URL::asset($language->language_flag)); ?>" <?php if($wizard['language'] == $language->language): ?> selected <?php endif; ?>> <?php echo e($language->language); ?></option>
												<?php else: ?>
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="card-footer border-0 text-center p-0">						
							<div class="w-100 pt-2 pb-2">
								<div class="text-center">
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2" id="generate-ideas"><?php echo e(__('Generate Ideas')); ?></button>
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2 hidden" id="generate-outlines"><?php echo e(__('Generate Outlines')); ?></button>
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2 hidden" id="generate-points"><?php echo e(__('Generate Talking Points')); ?></button>
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2 hidden" id="generate-images"><?php echo e(__('Generate Image')); ?></button>
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2 hidden" id="skip-step"><?php echo e(__('Skip this step')); ?></button>
								</div>
							</div>							
						</div>							
					</div>
				...
				<div id="final-wizard-status" class="hidden">
					<div class="row justify-content-center mt-6">
						<div class="col-sm-12 text-center">
							...
							<h4 class="fs-22 font-weight-bold" id="result-processing"><?php echo e(__('Generating the article...')); ?></h4>
							<h4 class="fs-22 font-weight-bold hidden" id="result-processed"><?php echo e(__('Successfully Generated')); ?></h4>
							<h4 class="fs-22 font-weight-bold hidden" id="result-cancelled"><?php echo e(__('Generating is stopped')); ?></h4>
							<p class="text-muted fs-12"><?php echo e(__('You can edit your article in documents once it is generated.')); ?></p>
							<div class="w-100 mt-4">
								<div class="text-center">
									<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2" id="new-wizard-large"><?php echo e(__('Create New')); ?></button>
								</div>
							</div>	
						</div>
					</div>
				...
				<div class="row">
							...
							<div class="card-body">
								<div class="wizard-content-heading">
									<div class="d-flex wizard-nav-text">
										...
										<div class="wizard-step-title"><span class="font-weight-bold fs-14" id="main-step-name"><?php echo e(__('Ideas List')); ?></span></div>
									</div>	
								</div>
							</div>
						</div>
					...
					<div class="col-sm-12 hidden" id="keywords-section">
						<div class="keywords-title text-center">
							<h6 class="font-weight-bold fs-12"><?php echo e(__('Choose your Keywords')); ?></h6>
						</div>
						<div id="keywords-wrapper"></div>
						<div class="keywords-actions mb-2">
							<a href="#" id="select-all-keywords" class="font-weight-bold fs-12"><?php echo e(__('Select All')); ?></a>
							<a href="#" id="unselect-all-keywords" class="font-weight-bold fs-12 hidden"><?php echo e(__('Unselect All')); ?></a>
						</div>
					</div>
					...
					<div class="card-footer border-0 text-center p-0">						
						<div class="w-100 pt-2 pb-2">
							<div class="text-center">
								<button type="button" class="btn btn-primary ripple pl-7 pr-7 fs-11 pt-2 pb-2 hidden" id="next-step"><?php echo e(__('Next Step')); ?> <i class="fa-solid fa-circle-chevron-right"></i></button>
							</div>
						</div>							
					</div>	
				</div>
	...
	$(function () {
		...
		$('#generate-keywords').on('click', function(e) {
			...
			if(document.getElementById("topic").value == '') {
				toastr.warning('<?php echo e(__('Please provide your topic description first')); ?>');
			} else {
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#generate-keywords').html('<?php echo e(__('Please Wait...')); ?>');          
					},			
					success: function (data) {	

						if (data['status'] == 'error') {
							
							Swal.fire('<?php echo e(__('Keywords Generation Issue')); ?>', data['message'], 'warning');
							$('#generate-keywords').prop('disabled', false);
							$('#generate-keywords').html('<?php echo e(__('Generate Keywords')); ?>'); 
		...
		$('#generate-ideas').on('click', function(e) {
			...
			if(document.getElementById("topic").value == '' && document.getElementById("keywords").value == '') {
				toastr.warning('<?php echo e(__('Please provide topic description or some keywords first')); ?>');
			} else {
				...
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#generate-ideas').html('<?php echo e(__('Please Wait...')); ?>');          
					},			
					success: function (data) {	

						if (data['status'] == 'error') {
							
							Swal.fire('<?php echo e(__('Ideas Generation Error')); ?>', data['message'], 'warning');
							$('#generate-ideas').prop('disabled', false);
							$('#generate-ideas').html('<?php echo e(__('Generate Ideas')); ?>'); 
		...
		$('#generate-outlines').on('click', function(e) {
			...
			if(document.getElementById("title").value == '') {
				toastr.warning('<?php echo e(__('Please provide your article title first')); ?>');
			} else {
				...
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#generate-outlines').html('<?php echo e(__('Please Wait...')); ?>');          
					},			
					success: function (data) {	
						if (data['status'] == 'error') {							
							Swal.fire('<?php echo e(__('Outlines Generation Error')); ?>', data['message'], 'warning');	
							$('#generate-outlines').prop('disabled', false);
							$('#generate-outlines').html('<?php echo e(__('Generate Outlines')); ?>'); 
							...
							if (data['result'] !== null) {
								...
								toastr.warning('<?php echo e(__('Outline generation is taking longer than expected, please try again')); ?>');
		...
		$('#generate-points').on('click', function(e) {
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#generate-points').html('<?php echo e(__('Please Wait...')); ?>');          
				},			
				success: function (data) {	
					if (data['status'] == 'error') {							
						Swal.fire('<?php echo e(__('Talking Points Generation Error')); ?>', data['message'], 'warning');	
						$('#generate-points').prop('disabled', false);
						$('#generate-points').html('<?php echo e(__('Generate Talking Points')); ?>'); 
						...
						if (data['result'] !== null) {
							...
							for (let i in outlines) {							
											...
											'<div class="d-flex w-100 outlines-outer">' +
												...
												'<div class="w-100 input-box mb-0">' +
													'<div class="form-group tp-section-title">' +
														'<input type="text" class="form-control" placeholder="<?php echo e(__('Section Title')); ?>" value="' + outlines[i] + '">' +
													'</div>' +
												'</div>' +
														...
														'<div class="d-flex w-100 outlines-outer">' +
															'<div class="w-100 input-box mb-0">' +
																'<div class="form-group tp-talking-point-'+i+'">' +
																	'<input type="text" class="form-control talking-point-result-input" placeholder="<?php echo e(__('Talking Points')); ?>" value="' + talking_points[j][k] + '">' +
																'</div>' +
															'</div>' +
															'<div class="items-center ml-3">' +
								...
								list += '<a href="#" class="fs-11 pl-6 text-muted add-new-talking-point" data-id="'+i+'"><i class="fa-solid fa-circle-plus mr-2"></i> <?php echo e(__('Add New Talking Point')); ?></a>' +
										'</ul>' +										
										'</div></li>';							
							}
							...
							toastr.warning('<?php echo e(__('Talking points generation is taking longer than expected, please try again')); ?>');
		...
		$('#generate-images').on('click', function(e) {
			...
			$.ajax({
				...
				beforeSend: function() {
					...
					$('#generate-images').html('<?php echo e(__('Please Wait...')); ?>');          
				},			
				success: function (data) {	

					if (data['status'] == 'error') {
						
						Swal.fire('<?php echo e(__('Images Generation Error')); ?>', data['message'], 'warning');
						$('#generate-images').prop('disabled', false);
						$('#generate-images').html('<?php echo e(__('Generate Images')); ?>'); 
		...
		$('#next-step').on('click', function(e) {
			...
			if (CURRENT_STEP == 1) {
				...
				$('#main-step-name').html('<?php echo e(__('Outlines List')); ?>');
				...
				$('#main-step-name').html('<?php echo e(__('Talking Points List')); ?>');
				...
				for (let i = 0; i < outlines_selected.length; i++) {
					list += '<li class="drag-item pl-0 pr-2 pb-2 pt-2 mb-2" draggable="true" id="list-'+i+'">' +
								'<div class="d-flex w-100 outlines-outer">' +
									...
									'<div class="w-100 input-box mb-0">' +
										'<div class="form-group">' +
											'<input type="text" class="form-control" placeholder="<?php echo e(__('Section Title')); ?>" value="' + outlines_selected[i] + '">' +
										'</div>' +
									'</div>' +
									'<div class="items-center ml-3">' +
										'<a href="#" class="text-muted remove-section"><i class="fa-solid fa-xmark fs-14"></i></a>' +
				...
				$('#main-step-name').html('<?php echo e(__('Images List')); ?>');
				...
				$('#main-step-name').html('<?php echo e(__('Final Article')); ?>');
		...
		$('#add-new-section').on("click", function(e) { 
			...
			let list = '<li class="drag-item pl-0 pr-2 pb-2 pt-2 mb-2" draggable="true">' +
						'<div class="d-flex w-100 outlines-outer">' +
							...
							'<div class="w-100 input-box mb-0">' +
								'<div class="form-group">' +
									'<input type="text" class="form-control" placeholder="<?php echo e(__('Section Title')); ?>">' +
								'</div>' +
							'</div>' +
							'<div class="items-center ml-3">' +
						...
						'<div class="d-flex w-100 outlines-outer">' +
							'<div class="w-100 input-box mb-0">' +
								'<div class="form-group tp-talking-point-'+id+'">' +
									'<input type="text" class="form-control talking-point-result-input" placeholder="<?php echo e(__('Talking Points')); ?>">' +
								'</div>' +
							'</div>' +
							'<div class="items-center ml-3">' +
								'<a href="#" class="text-muted remove-section outline-item-close"><i class="fa-solid fa-xmark fs-12"></i></a>' +
			...
			$.ajax({
				...
				success: function (data) {	
					...
					if (data['status'] == 'error') {
						...
						Swal.fire('<?php echo e(__('Article Generation Error')); ?>', data['message'], 'warning');
						...
						eventSource.onmessage = function (e) {
							if ( e.data == '[DONE]' ) {	
								...
								toastr.success('<?php echo e(__('Article Wizard completed and saved in documents successfully')); ?>');
								eventSource.close();
								editor.innerHTML += '<br>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/lskdnzmy/public_html/resources/views/user/templates/wizard/index.blade.php ENDPATH**/ ?>
					...
					<div class="tab-content" id="myTabContent">
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">
													...
													<select id="stable-diffusion-engine" name="stable-diffusion-engine" class="form-select" data-placeholder="{{ __('Set Stable Diffusion Engine ID') }}">
														...
														<option value='sd3-medium' @if (config('settings.image_stable_diffusion_engine') == 'sd3-medium') selected @endif> {{ __('SD 3.0 Medium') }}</option>		
														<option value='sd3-large' @if (config('settings.image_stable_diffusion_engine') == 'sd3-large') selected @endif> {{ __('SD 3.0 Large') }}</option>		
														<option value='sd3-large-turbo' @if (config('settings.image_stable_diffusion_engine') == 'sd3-large-turbo') selected @endif> {{ __('SD 3.0 Large Turbo') }}</option>		
						...
						<div class="tab-pane fade" id="api" role="tabpanel" aria-labelledby="api-tab">
							<form id="api-features-form" action="{{ route('admin.davinci.configs.store.api') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="card shadow-0 mb-7 plagiarism_grid1">							
									<div class="card-body">
								...
								@else
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6 col-sm-12 mb-2">
													<a href="{{ route('admin.davinci.configs.sd') }}" class="btn btn-primary ripple pl-7 pr-7" >{{ __('Set AI Photo Studio Prices') }}</a>
												</div>										
									...
									<div class="card shadow-0 mt-0">							
										<div class="card-body">
											...
											<h6 class="fs-12 font-weight-bold mb-4"><i class="fa-sharp fa-solid fa-circle-dollar text-danger fs-14 mr-2"></i>{{ __('AI Vendor Service Costs') }} <span class="text-muted">({{ __('For Subscription/Prepaid Plans') }})</span></h6>

											<div class="row">

												<div class="col-lg-6 col-md-6 col-sm-12 mb-2">
													<a href="{{ route('admin.davinci.configs.costs') }}" class="btn btn-primary ripple pl-7 pr-7" >{{ __('Update AI Vendor Service Costs') }}</a>
												</div>										
